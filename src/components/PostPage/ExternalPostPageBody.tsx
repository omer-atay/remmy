    ...
    <div className="flex flex-col border border-neutral-border-weak rounded-2xl">
      ...
      <div className="flex justify-between px-4 py-2 text-sm">
        <a className="flex justify-between items-center w-full" href={post.post.url} target="_blank">
          ...
          <button
            className="flex justify-between items-center px-3 py-2 font-semibold border border-neutral-border-medium rounded-full text-secondary-plain hover:text-secondary-plain-hover active:bg-secondary-background-selected"
            type="button"
          >
            Open
          </button>
